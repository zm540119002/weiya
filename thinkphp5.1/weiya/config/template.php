...
return [
    ...
    'tpl_replace_string' => [
        ...
        //h-ui.admin资源路径
        'hui_js_admin' => Request::domain() .'/static/h-ui.admin/js',
        'hui_css_admin' => Request::domain() .'/static/h-ui.admin/css',
        'hui_img_admin' => Request::domain() .'/static/h-ui.admin/images',
        'hui_skin_admin' => Request::domain() .'/static/h-ui.admin/skin',
    ],
];
