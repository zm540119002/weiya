...
return [
    ...
    'tpl_replace_string' => [
        ...
        //common_admin资源路径
        'common2_admin2_js' => Request::domain() .'/static/common_admin/js',
        'common2_admin2_css' => Request::domain() .'/static/common_admin/css',
        'common2_admin2_img' => Request::domain() .'/static/common_admin/img',
        //上传路径
