...
return [
    ...
    'tpl_replace_string' => [
        ...
        //common_admin资源路径
        'common2_admin_js' => Request::domain() .'/static/common_admin/js',
        'common2_admin_css' => Request::domain() .'/static/common_admin/css',
        'common2_admin_img' => Request::domain() .'/static/common_admin/img',
        //上传路径
